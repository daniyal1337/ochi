  ...
  return (
    ...
    <div className='eyes w-full h-screen overflow-hidden  ' >
      ...
      <div className='absolute flex gap-10  top-1/2 left-1/2   -translate-x-[50%] -translate-y-[50%] '>
            ...
            <div style={{transform:`translate(-50%, -50%) rotate(${rotate}deg)`}} className='line absolute top-1/2 left-1/2  -translat-x-[50%] -translate-y-[50%] w-full   '>
            ...
            <div style={{transform:`translate(-50%, -50%) rotate(${rotate}deg)`}} className='line absolute top-1/2 left-1/2  -translat-x-[50%] -translate-y-[50%] w-full  '>
                <div className=' w-10 h-10 bg-white rounded-full items-center '></div>
